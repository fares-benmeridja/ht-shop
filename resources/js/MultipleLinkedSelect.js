...
class MultipleLinkedSelect {
    ...
    showLoader () {
        ...
        this.$loader.className = 'loader-small'
...
let $selects = document.querySelectorAll('.multiple-linked-select')
$selects.forEach(function ($select) {
    new MultipleLinkedSelect($select)
})